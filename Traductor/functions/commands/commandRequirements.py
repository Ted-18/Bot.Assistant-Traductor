...
import addons.Traductor.settings.settingColors as settingColors
import addons.Traductor.settings.settingThumbnail as settingThumbnail
...
async def checkRequirements(ctx):
    # PERMISSIONS CHECK
    import addons.Traductor.functions.services.servicePermission as servicePermission
